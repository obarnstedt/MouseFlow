...
def runMF(dlc_dir=os.getcwd(),
    ...
    for bodyDLC in bodyfiles:
        ...
        motion_frontpaw_raw, _, motionangle_frontpaw = body_processing.dlc_pointmotion(dlc_body.values[:, 12],
                                                                                                dlc_body.values[:, 13],
                                                                                                dlc_body.values[:, 14])
        motion_backpaw_raw, _, motionangle_backpaw = body_processing.dlc_pointmotion(dlc_body.values[:, 24],
                                                                                            dlc_body.values[:, 25],
                                                                                            dlc_body.values[:, 26])
        ...
        motion_mouth_raw, _, motionangle_mouth = body_processing.dlc_pointmotion(dlc_body.values[:, 3],
                                                                                        dlc_body.values[:, 4],
                                                                                        dlc_body.values[:, 5])
        mouthmotion = body_processing.dlc_pointmotion(dlc_body.values[:, 3], dlc_body.values[:, 4], dlc_body.values[:, 5])
        motion_mouth_raw = mouthmotion.raw_distance
        ...
        cylinder_motion_raw, _ = body_processing.cylinder_motion(bodyfile, cylinder_mask)
